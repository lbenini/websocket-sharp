...
namespace Example
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (WebSocket ws = new("ws://localhost:4649/Echo"))
            ...
            //using (var ws = new WebSocket ("wss://localhost:5963/Chat?name=nobita"))
            {
                ...
                {
                    string fmt = "[WebSocket Message] {0}";
                    string body = !e.IsPing ? e.Data : "A ping was received.";
                ...
                ws.OnClose += (sender, e) =>
                {
                    string fmt = "[WebSocket Close ({0})] {1}";
